...
namespace BachelorApp
{
    ...
    {
        public static int ViewSingleNodeConnected(Int32 NodeID, int SiteID)
        {
            ...
            try
            {
                ...
                {
                    SqlCommand cmd = new SqlCommand(string.Format("SELECT DirectConnectedUsers FROM dbo.Nodes WHERE NodeID = '{0}' AND SiteID = '{1}'", NodeID, SiteID), conn);
                    conn.Open();
