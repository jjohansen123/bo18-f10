...
namespace BachelorApp
{
    ...
    {
        public static int ViewSingleNodeConnected(Int32 Lingling, int SiteID)
        {
            ...
            try
            {
                ...
                {
                    SqlCommand cmd = new SqlCommand(string.Format("SELECT DirectConnectedUsers FROM dbo.Nodes WHERE Lingling = '{0}' AND SiteID = '{1}'", Lingling, SiteID), conn);
                    conn.Open();
