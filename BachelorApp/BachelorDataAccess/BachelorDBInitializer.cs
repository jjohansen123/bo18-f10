...
namespace BachelorDataAccess
{
    class BachelorDBInitializer : DropCreateDatabaseIfModelChanges<BachelorContext>
    {
        protected override void Seed(BachelorContext context)
        {
            ...
            context.Nodes.Add(new Node() { Name = "Internet Connection", Comment ="This is the node that connects the network to the internet, also known as a gateway", SiteId = 1, LocalID = 1, ParentID = 0, Children = new List<Node>(), ModelId = 1 });
